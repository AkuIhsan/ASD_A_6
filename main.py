...
def Tampilan_Menu() :
    ...
    console.print("9. Mengurutkan antrian")
    console.print("10. Melihat isi antrian")
    console.print("11. Menerima antrian")
    console.print("12. Menolak antrian")
    console.print("13. Menghapus Antrian")
    console.print("14. Keluar")

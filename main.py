...
def Tampilan_Menu() :
    ...
    console.print(Rule("[bold cyan]Menu untuk mengatur tumpukan[/bold cyan]"))
    ...
    console.print(Rule("[bold cyan]Menu untuk mengatur dokumen[/bold cyan]"))
    ...
    console.print(Rule("[bold cyan]Menu untuk mengatur antrian[/bold cyan]"))
    ...
    console.print(Rule("[bold cyan]Keluar Program[/bold cyan]"))
...
def main() :
    ...
    while lanjut :
        ...
        if pilihan == "1" :
            ...
            system("cls" if name == "nt" else "clear")
            console.print(Rule(f"[bold cyan]{buat_antrian()}[/bold cyan]"))
